...
public class Residence extends Model {
	...
	public Residence(User from, String geolocation, String residenceType, String rented, int numbOfBedrooms, int rent, int numberOfBathrooms, int areaOfResidence) {
