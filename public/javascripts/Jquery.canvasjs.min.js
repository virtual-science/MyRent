...
(function() {
    ...
    function u(a, b, c) {
        ...
        Da(this.ctx),
        t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = V(a, b),
        ...
        this._toolTip = new R(this,this._options.toolTip,this.theme),
    ...
    function ka(a, b, c) {
        ...
        "undefined" === typeof this._options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
        this.lineHeight = ea(this.fontFamily, this.fontSize, this.fontWeight);
      ...
      , X = function(a, b, c) {
        ...
        for (var w = 0; k && w < k.length; w++)
            ...
            "." === b && 0 > p)
                ...
                0 > p ? (h.push(b),
                "#" === b || "0" === b ? m++ : "," === b && q++) : (l.push(b),
                "#" !== b && "0" !== b || n++)
            }
        r && (b = Math.floor(a),
        s = (0 === b ? "" : String(b)).length - m,
        g /= Math.pow(10, s));
        0 > p && (p = w);
        g = (a * g).toFixed(n);
        b = g.split(".");
    ...
    u.prototype._updateOptions = function() {
        ...
        this.panEnabled = !1),
        ha(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0,
        this.panEnabled = !1))) : this.panEnabled = this.zoomEnabled = !1;
        this._menuButton ? this.exportEnabled ? ha(this._menuButton) : S(this._menuButton) : this.exportEnabled && t && (this._menuButton = document.createElement("button"),
        Q(this, this._menuButton, "menu"),
        ...
        if (!this._dropdownMenu && this.exportEnabled && t) {
            ...
            F(b, "click", function() {
                za(a.canvas, "jpeg", a.exportFileName);
                S(a._dropdownMenu)
            }, !0);
        ...
        "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? Q(a, a._zoomButton, "zoom") : Q(a, a._zoomButton, "pan"),
        a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && Q(a, a._resetButton, "reset"));
    ...
    u.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * J || this.canvas.height !== b * J ? (fa(this.canvas, a, b),
        fa(this.overlaidCanvas, a, b),
        fa(this._eventManager.ghostCanvas, a, b),
        !0) : !1
    }
    ;
    ...
    u.prototype.render = function(a) {
        ...
        c ? ha(this._zoomButton, this._resetButton) : (S(this._zoomButton, this._resetButton),
        this._options.zoomEnabled && (this.zoomEnabled = !0,
        this.panEnabled = !1));
        this._processData();
        this._options.title && (this._title = new ba(this,this._options.title),
        ...
        if (this._options.subtitles)
            for (a = 0; a < this._options.subtitles.length; a++)
                this.subtitles = [],
                c = new ja(this,this._options.subtitles[a]),
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            ...
            c = 0; c < b.plotUnits.length; c++) {
                var f = b.plotUnits[c]
                  , g = null ;
                f.targetCanvas = null ;
                this.animatedRender && (f.targetCanvas = V(this.width, this.height),
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = V(this.width, this.height).getContext("2d"),
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                    var m = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity
                ...
                for (p = 0; p < k.dataPoints.length; p++) {
                    ...
                    if (!(d < m) || h) {
                        ...
                        if (d > n && !l)
                            ...
                            continue;k.dataPoints[p].label && (a.axisX.labels[d] = k.dataPoints[p].label);
    ...
    u.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], k = [], p = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                for (m = 0; m < l.dataPoints.length; m++) {
                    ...
                    l.dataPoints[m].x.getTime ? (f = !0,
                    d = l.dataPoints[m].x.getTime()) : d = l.dataPoints[m].x;
                    P(l.dataPoints[m].y) ? e = 0 : (e = l.dataPoints[m].y,
                    0 === h && (p = Math.min(e, p)));
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    if (0 < m) {
                        ...
                        null !== e && null !== l.dataPoints[m - 1].y && (w = e - l.dataPoints[m - 1].y,
                        0 > w && (w *= -1),
                    ...
                    if (!(d < r) || n) {
                        ...
                        if (d > s && !q)
                            ...
                            continue;l.dataPoints[m].label && (a.axisX.labels[d] = l.dataPoints[m].label);
                        d < c.viewPortMin && (c.viewPortMin = d);
                        d > c.viewPortMax && (c.viewPortMax = d);
            ...
            for (m in g)
                ...
                a < b.min && (b.min = Math.min(a, p)),
                a > b.max && (b.max = a),
                m < c.viewPortMin || m > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = Math.min(a, p)),
    ...
    u.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, k = !1, p = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                for (m = 0; m < l.dataPoints.length; m++) {
                    ...
                    if (0 < m) {
                        ...
                        0 > w && (w *= -1);
                        c.minDiff > w && 0 !== w && (c.minDiff = w);
                        P(e) || null === l.dataPoints[m - 1].y || (w = e - l.dataPoints[m - 1].y,
                        0 > w && (w *= -1),
                        b.minDiff > w && 0 !== w && (b.minDiff = w))
                    }
                    if (!(d < r) || n) {
            ...
            g && !k ? (b.max = P(b.viewPortMax) ? 99 : Math.max(b.viewPortMax, 99),
            b.min = P(b.viewPortMin) ? 1 : Math.min(b.viewPortMin, 1)) : g && k ? (b.max = P(b.viewPortMax) ? 99 : Math.max(b.viewPortMax, 99),
            b.min = P(b.viewPortMin) ? -99 : Math.min(b.viewPortMin, -99)) : !g && k && (b.max = P(b.viewPortMax) ? -1 : Math.max(b.viewPortMax, -1),
            b.min = P(b.viewPortMin) ? -99 : Math.min(b.viewPortMin, -99));
            b.viewPortMin = b.min;
            b.viewPortMax = b.max;
            a.dataPointYSums = p
        }
                ...
                for (l = 0; l < h.dataPoints.length; l++) {
                    ...
                    if (!(d < q) || m) {
                        ...
                        if (d > r && !n)
                            ...
                            continue;h.dataPoints[l].label && (a.axisX.labels[d] = h.dataPoints[l].label);
                        d < c.viewPortMin && (c.viewPortMin = d);
                        d > c.viewPortMax && (c.viewPortMax = d);
    ...
    u.prototype._plotAreaMouseUp = function(a, b) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                g && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (ha(this._zoomButton, this._resetButton),
                Q(this, this._zoomButton, "pan"),
                Q(this, this._resetButton, "reset")))
            }
        }
    ...
    u.prototype.renderIndexLabels = function(a) {
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = f = e = 0, p = 0; p < this._indexLabels.length; p++) {
            var h = this._indexLabels[p], g = h.chartType.toLowerCase(), l, m, n = N("indexLabelFontColor", h.dataPoint, h.dataSeries), k = N("indexLabelFontSize", h.dataPoint, h.dataSeries);
            ...
            if (null !== w && "" !== w) {
                ...
                if (0 <= g.indexOf("line") || 0 <= g.indexOf("area") || 0 <= g.indexOf("bubble") || 0 <= g.indexOf("scatter")) {
                    ...
                    if (h.dataPoint.x < v.viewportMinimum || h.dataPoint.x > v.viewportMaximum || h.bounds.x1 > b.x2 || h.bounds.x2 < b.x1)
                        continue
                } else if (h.dataPoint.x < v.viewportMinimum || h.dataPoint.x > v.viewportMaximum)
                    continue;e = f = 2;
                "horizontal" === r ? (d = n.width,
                k = n.height) : (k = n.width,
                d = n.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    e = b.y2,
                    0 < s ? (m = h.point.y - k - f,
                    m < d && (m = "auto" === c ? Math.max(h.point.y, d) + f : d + f)) : (m = h.point.y + f,
                    m > e - k - f && (m = "auto" === c ? Math.min(h.point.y, e) - k - f : e - k - f))) : (d = Math.max(h.bounds.y1, b.y1),
                    ...
                    0 < s ? (m = Math.max(h.point.y, c) - k / 2,
                    m < d && ("bubble" === g || "scatter" === g) && (m = Math.max(h.point.y - k - f, b.y1 + f))) : (m = Math.min(h.point.y, c) - k / 2,
                    m > e - k - f && ("bubble" === g || "scatter" === g) && (m = Math.min(h.point.y + f, b.y2 - k - f))),
                    m = Math.min(m, e - k))
                } else
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < k.length) {
                    for (var q = !1, l = 0; l < k.length; l++)
                        if (m = k[l].x.getTime ? k[l].x.getTime() : k[l].x,
                        !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[l].y)
                                ...
                                n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
    ...
    u.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < k.length) {
                    for (var q = !1, l = 0; l < k.length; l++)
                        if (m = k[l].getTime ? k[l].x.getTime() : k[l].x,
                        !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[l].y)
                                0 < l && (b.stroke(),
                                t && c.stroke()),
                                ...
                                c.moveTo(m, n))));
                                if (0 < k[l].markerSize || 0 < g.markerSize)
                                    r = g.getMarkerProperties(l, m, n, b),
                                    d.push(r),
                                    s = B(s),
                                    t && d.push({
                                        x: m,
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length)
                    for (l = 0; l < p.length; l++)
                        if (m = p[l].getTime ? p[l].x.getTime() : p[l].x,
                        !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof p[l].y)
                                ...
                                m = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (m - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
    ...
    var I = function(a, b, c, d, e, f, g, k, p, h, l, m, n) {
        ...
        a.strokeStyle = k,
        a.moveTo(b, c),
        a.rect(b - n, c - n, d - b + 2 * n, e - c + 2 * n),
        a.stroke());
        a.restore();
        !0 === p && (a.save(),
        a.beginPath(),
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    for (var y = !0; n < l.length; n++)
                        if (s = l[n].x.getTime ? l[n].x.getTime() : l[n].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof l[n].y)
                                ...
                                0 !== l[n].markerSize && (0 < l[n].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(n, q, r, c),
                                g.push(s),
                                z = B(z),
                                t && g.push({
                                    x: q,
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < l.length) {
                    ...
                    for (c.setLineDash && c.setLineDash(M(h.lineDashType, h.lineThickness)); m < l.length; m++)
                        if (n = l[m].x.getTime ? l[m].x.getTime() : l[m].x,
                        !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof l[m].y)
                                ...
                                if (0 !== l[m].markerSize && (0 < l[m].markerSize || 0 < h.markerSize)) {
                                    var E = h.getMarkerProperties(m, n, q, c);
                                    g.push(E);
                                    x = B(x);
                                    t && g.push({
                                        x: n,
    ...
    u.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            t && (n.beginPath(),
            n.rect(e.x1, e.y1, e.width, e.height),
            n.clip());
            xValuePresent = [];
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, q = 0, e = 0; e < m.length; e++)
                        ...
                        !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                            ...
                            b.globalAlpha = 1;
                            Math.sqrt((n - f) * (n - f) + (q - g) * (q - g)) < Math.min(r.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = l.dataPointIds[e],
                            ...
                            n = B(n),
                            t && K.drawMarker(r.x, r.y, this._eventManager.ghostCtx, r.type, r.size, n, n, r.borderThickness),
                            (m[e].indexLabel || l.indexLabel || m[e].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[e],
                                dataSeries: l,
                                point: {
                ...
                if (0 < m.length)
                    for (var n = 5 < k && l.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)
                        ...
                        !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                            ...
                            if (m[e].indexLabel || l.indexLabel || m[e].indexLabelFormatter || l.indexLabelFormatter)
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (e = 0; e < n.length; e++)
                        if (n[e].getTime ? k = n[e].x.getTime() : k = n[e].x,
                        !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    for (var x = !0; m < h.length; m++)
                        if (s = h[m].x.getTime ? h[m].x.getTime() : h[m].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null !== h[m].y && h[m].y.length && "number" === typeof h[m].y[0] && "number" === typeof h[m].y[1]) {
                                ...
                                if (0 !== h[m].markerSize && (0 < h[m].markerSize || 0 < p.markerSize)) {
                                    ...
                                    u = p.getMarkerProperties(m, n, q, c);
                                    e.push(u);
                                    y = B(s);
                                    t && e.push({
                                        x: n,
    ...
    u.prototype.renderPie = function(a) {
        ...
        function c(a) {
            ...
            for (b = b = 0; b < l.length; b++)
                ...
                d = 0,
                d = "left" === c.hemisphere ? "inside" !== h.indexLabelPlacement ? -(c.indexLabelTextBlock.width + m) : -c.indexLabelTextBlock.width / 2 : "inside" !== h.indexLabelPlacement ? m : -c.indexLabelTextBlock.width / 2,
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                for (a = 0; a < l.length; a++)
                    ...
                    0 !== u.height && 0 !== u.width)
                        u = u = 0,
                        "right" === k.hemisphere ? (u = n.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + m),
                        u *= -1) : u = n.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width - m),
                        0 < u && (!g && k.indexLabelText && (w = "right" === k.hemisphere ? n.x2 - k.indexLabelTextBlock.x : k.indexLabelTextBlock.x - n.x1,
                        ...
                        u > c && (c = u)),
                        u = u = 0,
                        0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? (u = n.y2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + 5),
                        u *= -1) : u = n.y1 - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - 5),
            ...
            if (0 !== u) {
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    for (b = 0; b < l.length; b++) {
                        ...
                        d > c && sa(p.plotArea.ctx, q[b].center, q[b].radius, f, h.type, c, d, h.fillOpacity, q[b].percentInnerRadius);
                        if (e)
                            break
                    }
                    k()
    ...
    ka.prototype.render = function() {
            ...
            if ("pie" !== l.type && "doughnut" !== l.type && "funnel" !== l.type) {
                ...
                for (var v = 0; v < l.dataPoints.length; v++) {
                    var u = l.dataPoints[v]
                      ...
                      , n = this.chart.replaceKeywordsWithValue(n, u, l, v)
                      , m = {
                        markerType: m,
                        markerColor: q,
                        text: n,
                ...
                if (!(0 >= g || "undefined" === typeof g || 0 >= n || "undefined" === typeof n)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!l || l.width + Math.round(m.textBlock.width + 0.1 * this.horizontalSpacing + r + (0 === l.width ? 0 : this.horizontalSpacing) + ("line" === m.chartType || "spline" === m.chartType || "stepLine" === m.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                            ...
                            this.height += v,
                            v = 0;
                        v = Math.max(v, m.textBlock.height)
                    } else
                        m.textBlock = new H(this.ctx,{
                            x: 0,
                            y: 0,
                        ...
                        p.push(l)) : (l = p[u],
                        u = (u + 1) % p.length),
                        this.height += m.textBlock.height;
        ...
        for (h = 0; h < this.items.length; h++)
            m = k[h],
            m.id = ++this.chart._eventManager.lastObjectId,
            this.chart._eventManager.objectMap[m.id] = {
                id: m.id,
        ...
        for (h = b = 0; h < p.length; h++) {
            ...
            for (k = v = 0; k < l.items.length; k++) {
                ...
                q = d + b;
                u = n;
                this.chart.data[m.dataSeriesIndex].visible || (this.ctx.globalAlpha = 0.5);
                this.ctx.save();
                this.ctx.rect(e, d, f, g);
                this.ctx.clip();
                if ("line" === m.chartType || "stepLine" === m.chartType || "spline" === m.chartType)
                    this.ctx.strokeStyle = m.lineColor,
                    this.ctx.lineWidth = Math.ceil(this.lineHeight / 8),
                    this.ctx.beginPath(),
                    this.ctx.moveTo(n - 0.1 * this.lineHeight, q + this.lineHeight / 2),
                    this.ctx.lineTo(n + 0.7 * this.lineHeight, q + this.lineHeight / 2),
                    this.ctx.stroke(),
                    u -= 0.1 * this.lineHeight;
                K.drawMarker(n + r / 2, q + this.lineHeight / 2, this.ctx, m.markerType, m.markerSize, m.markerColor, m.markerBorderColor, m.markerBorderThickness);
                ...
                if (n) {
                    ...
                    case "rangeBar":
                        a >= n.x1 && (a <= n.x2 && b >= n.y1 && b <= n.y2) && (d.push({
                            ...
                            dataPointIndex: f,
                            dataSeries: this,
                            distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y1 - b), Math.abs(n.y2 - b))
                        }),
                        k = !0);
                        break;
                    case "line":
                    ...
                    case "rangeSplineArea":
                        ...
                        t = c ? 20 : s;
                        r = Math.min(Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - b, 2)), Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y2 - b, 2)));
                        r <= t && d.push({
                            dataPoint: q,
                            dataPointIndex: f,
                            dataSeries: this,
                    ...
                    case "doughnut":
                        ...
                        r < n.radius && r > t && (r = Math.atan2(b - s.y, a - s.x),
                        0 > r && (r += 2 * Math.PI),
                        r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        s = Number(((180 * (n.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        t = Number(((180 * (n.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        0 === t && 1 < n.endAngle && (t = 360),
                        s >= t && 0 !== q.y && (t += 360,
                        r < s && (r += 360)),
                        r > s && r < t && (d.push({
                            dataPoint: q,
                        ...
                        break;
                    case "candlestick":
                        if (a >= n.x1 - n.borderThickness / 2 && a <= n.x2 + n.borderThickness / 2 && b >= n.y2 - n.borderThickness / 2 && b <= n.y3 + n.borderThickness / 2 || Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && b >= n.y1 && b <= n.y4)
                            d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
    ...
    C.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c = ta(new Date(this.viewportMaximum), this.interval, this.intervalType),
            b = this.intervalStartPosition; b < c; ta(b, this.interval, this.intervalType))
                a = b.getTime(),
                ...
                }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : ra(b, this.valueFormatString, this.chart._cultureInfo),
                a = new H(this.ctx,{
                    x: 0,
                    y: 0,
                    maxWidth: d,
    ...
    C.setLayoutAndRender = function(a, b, c, d, e) {
        ...
        if ("normal" === d) {
            ...
            g = Math.round(10 > e.y1 ? 10 : e.y1),
            k = Math.round(e.x1 + m + b.margin),
            d = Math.round(e.y2 - n - a.margin),
            b.lineCoordinates = {
                x1: k,
                y1: g,
                x2: k,
            ...
            b && (b.lineCoordinates = {},
            f = Math.round(e.x1 + m + a.margin),
            k = Math.round(e.x2 > b.chart.width - 10 ? b.chart.width - 10 : e.x2),
            b.lineCoordinates.x1 = f,
            b.lineCoordinates.x2 = k,
            b.lineCoordinates.width = Math.abs(k - f));
            c && (c.lineCoordinates = {},
            f = Math.round(e.x1 + m + a.margin),
            k = Math.round(e.x2 > c.chart.width - 10 ? c.chart.width - 10 : e.x2),
            c.lineCoordinates.x1 = f,
            c.lineCoordinates.x2 = k,
            c.lineCoordinates.width = Math.abs(k - f));
            var n = Math.ceil(b ? b.createLabelsAndCalculateHeight() : 0)
              , q = Math.ceil(c ? c.createLabelsAndCalculateHeight() : 0);
            b && (g = Math.round(e.y2 - n - b.margin),
            d = Math.round(e.y2 - l > b.chart.height - 10 ? b.chart.height - 10 : e.y2 - l),
            b.lineCoordinates.y1 = g,
            b.lineCoordinates.y2 = g,
            b.boundingRect = {
                x1: f,
                y1: g,
                x2: k,
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (g = this.chart.getDataPointAtXY(a, b, !0))
                    ...
                    if (g = xa(a, b, this.chart._eventManager.ghostCtx),
    ...
    R.prototype.highlightObjects = function(a) {
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                b.globalAlpha = 0.3,
                K.drawMarkers([f]),
                b.globalAlpha = 1) : "column" === d.type || "stackedColumn" === d.type || "stackedColumn100" === d.type || "bar" === d.type || "rangeBar" === d.type || "stackedBar" === d.type || "stackedBar100" === d.type || "rangeColumn" === d.type ? I(b, e.x1, e.y1, e.x2, e.y2, "white", 0, null , !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? sa(b, e.center, e.radius, "white", d.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "candlestick" === d.type ? (b.globalAlpha = 1,
